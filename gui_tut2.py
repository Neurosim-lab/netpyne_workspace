...
## Cell property rules
netParams.importCellParams(label='PT', fileName='cells/PTcell.hoc', cellName='PTcell', conds={'cellType': 'PT'}, somaAtOrigin=True) 
netParams.importCellParams(label='FS', fileName='cells/FScell.hoc', cellName='FScell', conds={'cellType': 'FS'}) 

## Population parameters
netParams.popParams['E'] = {'cellType': 'PT', 'numCells': 3}
netParams.popParams['I'] = {'cellType': 'FS', 'numCells': 10}
...
netParams.synMechParams['AMPA'] = {'mod': 'Exp2Syn', 'tau1': 0.05, 'tau2': 5.3, 'e': 0}
