...
'''
USING PREV NEURON:
 network with 120 cells, 1134 conns, LFP runtime:
- without rxd extracellular: 17 sec
- with rxd extracellular: 104 sec
'''
...
if addExtra:
    ...
    na_ecs.states3d[:] = 140
    k_ecs.states3d[:] = 4
    rxd_na[extracellular].states3d[:] = 5
    rxd_k[extracellular].states3d[:] = 50

sim.simulate()
sim.analyze()

# plotting: http://docs.enthought.com/mayavi/mayavi/auto/example_volume_slicer.html
